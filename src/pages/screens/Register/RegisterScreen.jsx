                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                      />
                      <User size={20} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-stone-400" />
                    </div>
                  </div>
                  <div>
                      ...
                      {passwordRequirements.map((req, index) => (
                        <div key={index} className="flex items-center gap-2 text-xs">
                          <div className={`w-3 h-3 rounded-full flex items-center justify-center ${
                            req.test(formData.password) ? 'bg-green-100' : 'bg-stone-100'
                          }`}>
                            {req.test(formData.password) && (
                              <Check size={8} className="text-green-600" />
                            )}
                          </div>
                          <span className={req.test(formData.password) ? 'text-green-600' : 'text-stone-500'}>
                            {req.text}
                          </span>
                        </div>
                      ))}

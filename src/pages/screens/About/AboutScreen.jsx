...
import { Award, Shield, Truck, HeartHandshake, Scissors, Users } from 'lucide-react'
  ...
  const values = [
    {
      ...
      description: 'We use only the finest full-grain leather, sourced ethically and sustainably.'
    },
    {
      icon: Scissors,
      title: 'Handcrafted Excellence',
      description: 'Each piece is meticulously handcrafted by skilled artisans using traditional techniques.'
    },
    {
      icon: Truck,
      title: 'Timely Delivery',
      description: 'Fast, secure shipping with careful packaging to protect your investment.'
    },
    {
      icon: HeartHandshake,
      title: 'Customer First',
      description: 'Your satisfaction is our priority, with lifetime warranty on all premium products.'
    }
  ]
        ...
        <Container>
          ...
          >
            ...
            <p className="text-xl text-stone-600 max-w-4xl mx-auto leading-relaxed">
              ...
              Each piece in our collection tells a story of traditional techniques, premium materials, 
          ...
          >
            {stats.map(({ label, value, icon: Icon }, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-stone-900 mb-2">{value}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-semibold mb-6 text-stone-900">Our Heritage</h2>
              <p className="text-stone-600 leading-relaxed mb-6">
                IVOLEX began as a small workshop in the heart of Italy&apos;s leather district, 
                where master craftsmen have perfected their art for generations. Our founder, 
                inspired by traditional techniques and driven by a vision for modern excellence, 
                established IVOLEX to bring authentic leather craftsmanship to the world.
              </p>
              <p className="text-stone-600 leading-relaxed mb-6">
                Today, we continue this legacy, combining time-honored methods with contemporary 
                design and sustainable practices. Every IVOLEX piece carries the soul of traditional 
                craftsmanship into the modern world.
              </p>
              <div className="bg-brand-50 border border-brand-200 rounded-xl p-6">
                <h3 className="font-semibold text-brand-900 mb-2">Our Promise</h3>
                <p className="text-brand-800 text-sm">
                  Every IVOLEX product comes with a lifetime warranty, reflecting our confidence 
                  in the quality and durability of our craftsmanship.
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <div className="text-lg font-semibold">Where Excellence Begins</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl font-semibold mb-4 text-stone-900">Our Values</h2>
              <p className="text-stone-600 max-w-2xl mx-auto">
                These principles guide everything we do, from selecting materials 
                to delivering your finished product.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map(({ icon: Icon, title, description }, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-3 text-stone-900">{title}</h3>
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl font-semibold mb-4 text-stone-900">Master Craftspeople</h2>
              <p className="text-stone-600 max-w-2xl mx-auto">
                Meet the skilled artisans who bring passion and expertise to every piece they create.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {craftspeople.map((member, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-1 text-stone-900">{member.name}</h3>
                  <p className="text-brand-600 text-sm mb-3 font-medium">{member.role}</p>
          ...
          >
            <h2 className="text-3xl font-semibold mb-4 text-stone-900">Experience IVOLEX Quality</h2>
            <p className="text-stone-600 mb-8 max-w-2xl mx-auto text-lg">
              Discover the difference that genuine craftsmanship makes. Each piece tells a story 
              of dedication, skill, and passion for leather artistry.
            </p>

...
import { 
  Shield, Users, Eye, AlertTriangle, 
  Activity, Lock, Settings, Bell
} from 'lucide-react';
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{securityMetrics.lastSecurityScan.split(' ')[1]}</p>
              <p className="text-xs text-gray-600">{securityMetrics.lastSecurityScan.split(' ')[0]}</p>
            </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-blue-800 text-sm space-y-1">
              ...
              <li>• Consider reducing session timeout to 15 minutes for high-security areas</li>
              <li>• Implement role-based access control for sensitive operations</li>
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Manage your security settings and policies</p>
        </div>
        
        <div className="p-6 space-y-6">
          {/* Authentication Settings */}
          <div>
            <h4 className="font-medium text-gray-900 mb-4">Authentication Settings</h4>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Monitor and manage your security infrastructure</p>
          </div>
        </div>
      </div>

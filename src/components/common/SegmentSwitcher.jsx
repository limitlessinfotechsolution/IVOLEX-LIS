          ...
          return (
            ...
            >
              ...
              <div className="text-left">
                <div className="leading-tight">{segment.name}</div>
                <div className="text-xs text-foreground/40 mt-0.5 leading-tight">
...
export function FloatingSegmentSwitcher({
  ...
  // Check if the className contains expanded styles
  const isExpandedView = className?.includes('flex-col') || isExpanded
      ...
      {segments.map(segment => {
        ...
        return (
          <motion.button
            ...
            } ${isExpandedView ? 'w-full justify-start mb-1 last:mb-0' : ''}`}
            style={{
          ...
          >
            <Icon size={14} />
            <span
              className={`${isExpandedView ? 'inline' : 'hidden sm:inline'} ${isActive ? 'text-white' : ''}`}
            >
              {segment.name}
            </span>

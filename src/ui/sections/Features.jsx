  ...
  return (
    <section className="py-16 bg-white">
      <div className="container-xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose IVOLEX</h2>
          ...
          {feats.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <IconComponent size={32} className={`${feature.color} group-hover:scale-110 transition-transform duration-300`} />
                </motion.div>
